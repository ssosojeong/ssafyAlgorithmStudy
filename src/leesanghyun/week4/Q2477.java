...
// 김형균 : 방향에 대한 정보를 저렇게 깔끔하게 정리하는 것은 생각도 못했네요! 근데 궁금한게 혹시 노드를 쓰신 이유가 있으신걸까요? 
// 	   노드를 정의하게 되니까 Override도 해야하는거 같은데 가로,세로에 대한 정보를 new int[3] 2개로 처리해서 Collection.sort을 사용하는건 어떤가요?
