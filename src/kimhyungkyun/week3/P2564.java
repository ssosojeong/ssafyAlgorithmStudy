...
//김형균: 말씀해주신 arr에 대해서 꼼꼼히 보면서 제 코드를 다시 읽어보았습니다.
//        그러니 nearest()에서도 arr이 필요가 없고 setPoint() 굳이 2차원 배열을 만들 필요가 없었습니다. 
//        그냥 제가 코드를 작성할 때 이해하기 좋기 위해서 들어간 느낌이였습니다. 좋은 피드백 감사합니다. ^^
